...
namespace siges.Migrations
{
    ...
    [Migration("20200820181340_ContactoCliente")]
            ...
            modelBuilder.Entity("siges.Models.ContactoCliente", b =>
                {
                    ...
                    b.HasOne("siges.Models.Persona", "CreadorPor")
                        .WithMany()
                        .HasForeignKey("CreadorPorId");

                    b.HasOne("siges.Models.Persona", "ModificadoPor")
                        .WithMany()
