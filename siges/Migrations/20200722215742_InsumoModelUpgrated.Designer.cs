...
namespace siges.Migrations
{
    ...
    [Migration("20200722215742_InsumoModelUpgrated")]
    partial class InsumoModelUpgrated
    {
            ...
            modelBuilder.Entity("siges.Models.OrdenInsumo", b =>
                {
                    ...
                    b.HasOne("siges.Models.Lote", "LoteD")
                        .WithMany()
                        .HasForeignKey("LoteDId");
