...
jQuery(document).ready(function($){
  ...
  function Calendar(element, Args) {
    ...
    this.conf = {
      locale: (Args.locale) ? Args.locale : 'es',
      view: 'week',
      ...
      month: {
        ...
        day: {
          format: (Args.month) ? (Args.month.day) ? (Args.month.day.format) ? Args.month.day.format : 'DD' : 'DD' : 'DD'
        }
      },
  ...
  Calendar.prototype.weekDrawDays = function() {
    ...
    if (this.getView() == 'day'){
      div.text(this.miscUcfirstString(moment.unix(this.conf.unixTimestamp).format(this.conf.weekday.dayline.month.weekFormat)) + " semana");
